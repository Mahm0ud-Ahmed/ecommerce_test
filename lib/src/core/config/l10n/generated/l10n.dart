...
class S {
  ...
  /// `Product Details`
  String get product_details_page_app_bar_title {
    return Intl.message(
      'Product Details',
      name: 'product_details_page_app_bar_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Description`
  String get product_details_page_description_section_title {
    return Intl.message(
      'Description',
      name: 'product_details_page_description_section_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Genres`
  String get product_details_page_genres_section_title {
    return Intl.message(
      'Genres',
      name: 'product_details_page_genres_section_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Favorites`
  String get favorites_page_app_bar_title {
    return Intl.message(
      'Favorites',
      name: 'favorites_page_app_bar_title',
      desc: '',
      args: [],
    );
  }

  /// `Your favorites page is empty, maybe because you haven't added anything to it yet.`
  String get favorites_page_empty_title {
    return Intl.message(
      'Your favorites page is empty, maybe because you haven\'t added anything to it yet.',
      name: 'favorites_page_empty_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Delete All`
  String get favorites_page_clear_btn_title {
    return Intl.message(
      'Delete All',
      name: 'favorites_page_clear_btn_title',
      desc: '',
      args: [],
    );
  }
